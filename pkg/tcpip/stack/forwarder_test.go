...
func TestForwardingWithFakeResolverPartialTimeout(t *testing.T) {
	...
	if nh := p.Pkt.NetworkHeader.ViewToPacketEnd(); nh[dstAddrOffset] != 3 {
...
func TestForwardingWithFakeResolverManyPackets(t *testing.T) {
	...
	for i := 0; i < maxPendingPacketsPerResolution; i++ {
		...
		b := p.Pkt.NetworkHeader.ViewToPacketEnd()
...
func TestForwardingWithFakeResolverManyResolutions(t *testing.T) {
	...
	for i := 0; i < maxPendingResolutions; i++ {
		...
		if nh := p.Pkt.NetworkHeader.ViewToPacketEnd(); nh[dstAddrOffset] < 8 {
